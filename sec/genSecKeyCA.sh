...
openssl genrsa 2048 -sha256 > ca/ca_server.key
openssl req -new  -config server001.conf -subj "//C=JP\ST=Kanagawa\O=Tama\OU=Nakanoshima\CN=cad001" -key ca/ca_server.key  > ca/ca.csr
